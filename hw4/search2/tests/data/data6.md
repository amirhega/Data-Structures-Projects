...
[CMakeLists.txt](tests/data/data2.md) that can be used on a wide range of platforms. If you don't have CMake installed already, you can
...
[this separate article](test/data/data5.md) 
...
see file [include/gtest/internal/gtest-port.h](tests/data/data5.md).
