...
<ul id="ProjectSubmenu">
    ...
    *   [Automatic Escaping for Special Characters](tests/data/data2.md)
    *   [Code](tests/data/data1.md)
...
Similarly, because Markdown supports [inline HTML](tests/data/data9.md), if you use
...
title for the link, surrounded in quotes. For example:
    ...
    This is [an example](tests/data/data4.md) inline link.
...
Markdown's inline link style:
    ...
    than from [Yahoo](http://search.yahoo.com/) or
...
Inline image syntax looks like this:
    ...
    ![Alt text](tests/data/data1.md)

    +_*&^%$#@!!![New text](tests/data/data1.md)
