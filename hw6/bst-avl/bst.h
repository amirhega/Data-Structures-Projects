...
protected:
    ...
    bool isLeftChild(Node<Key, Value>* current, Node<Key, Value>* parent);
    bool isRightChild(Node<Key, Value>* current, Node<Key, Value>* parent);
    int depth(Node<Key,Value>* curr, bool& attempt) const;
...
void BinarySearchTree<Key, Value>::insert(const std::pair<const Key, Value> &keyValuePair)
{
    ...
    //if empty
    if(empty()) {
        Node<Key, Value>* root = new Node<Key,Value>(keyValuePair.first, keyValuePair.second, NULL);
        root_ =  root;
    } else {
        bool temp =  true;
        ...
        while(temp) {
            ...
            if(key > curr->getKey()) {
                ...
                if(curr->getRight() == NULL) {
                    Node<Key, Value>* node = new Node<Key, Value>(key, keyValuePair.second, curr);
                    curr->setRight(node);
                    temp  = false;
                } else {
                    curr = curr->getRight();
...
void BinarySearchTree<Key, Value>::remove(const Key& key)
{
    ...
    if(curr->getLeft() != NULL && curr->getRight() != NULL) {
        ...
        if(curr->getLeft() != NULL) {
            if(isRightChild(curr, curr->getParent())) {
        ...
        else if(!isRightChild(curr, curr->getParent())) {
...
void BinarySearchTree<Key, Value>::clearHelper(Node<Key, Value>* curr) {
    ...
    if(curr == NULL) return;
    //has two children recurse both, else just recurse on child exists
    if(curr->getLeft() != NULL && curr->getRight() != NULL) {
...
BinarySearchTree<Key, Value>::getSmallestNode() const
{
    // TODO
    Node<Key, Value>* curr = root_;
    //smallest is the leftest of the tree
...
bool BinarySearchTree<Key, Value>::isBalanced() const
{
    ...
    int trash = depth(curr, temp);
    trash++;
    return temp;
}

template<typename Key, typename Value>
int BinarySearchTree<Key, Value>::depth(Node<Key,Value>* curr, bool& attempt) const {
    
    if (curr == NULL) {
        return 0;
    } else {
        int leftH = depth(curr->getLeft(), attempt);
        int rightH = depth(curr->getRight(), attempt);
 ...
 */
template<typename Key, typename Value>
bool BinarySearchTree<Key, Value>::isLeftChild(Node<Key, Value>* current, Node<Key, Value>* parent) {

    if(parent != NULL) {
        return parent->getLeft() == current;
    }
    return false;
...
template<typename Key, typename Value>
bool BinarySearchTree<Key, Value>::isRightChild(Node<Key, Value>* current, Node<Key, Value>* parent) {
