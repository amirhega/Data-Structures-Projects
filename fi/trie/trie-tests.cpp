...
TEST(InsertOneLevel1, OneInsertion1)
{
	SparseTrie trie;
	trie.insert("caa");
	trie.insert("cab");
	...
	EXPECT_TRUE(trie.contains("caa"));
	EXPECT_TRUE(trie.contains("cab"));
	EXPECT_TRUE(trie.contains("cac"));
	EXPECT_TRUE(trie.contains("cae"));
	EXPECT_FALSE(trie.contains("cad"));
