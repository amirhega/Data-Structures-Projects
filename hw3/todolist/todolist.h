...
private:
    ...
    void addHighPriority(bool highPriority, std::string v, Item* temp);
    DailyTodoList::Item* listItem(size_t dayIndex, size_t loc, bool highPriority, Item* location);
    void invalidLocation(bool valid);
